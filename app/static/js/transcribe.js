...
However, none of the code is copied, and various bugs from that demo
...
$(document).on('ready', function() {
	...
	$('#off-button').hide(); //I made a CSS class display-none, but it requires
				//"!important" to overwrite fontawesome CSS, and that interferes
				//with JQuery's show()/hide(). So this is the cleanest solution
